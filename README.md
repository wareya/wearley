...
You may use this code under any of the following licenses, at your choice: CC0, Unlicense, BSD-0, WTFPL. However, I would appreciate a shoutout or "thanks" wherever the best place to put one is, if there is an appropriate place for one. Consider also thanking other existing Earley work if it's relevant to how you use this.
